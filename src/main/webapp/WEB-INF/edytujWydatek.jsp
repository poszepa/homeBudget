...
<div class="container">
    <div class="row">
        <div class="col">
            <form class="dodajWydatek" method="post" action="/homebudget/app/edytujWydatek">
            ...
            <form class="dodajWydatek flex-right" method="post" action="/homebudget/app/usunWydatek">
                <input type="hidden" name="id" value="${wydatek.id}">
                <input type="hidden" name="kategoria" value="${kategoria}">
                <input type="hidden" name="nazwaBazy" value="${nazwaBazy}">
